...
<script src="/packages/angular-chart.js-master/dist/angular-chart.js"></script>
@stop
...
<div class="container" ng-app="graficasApp">
    ...
    <div class="col-lg-12 col-sm-12" id="bar-chart" ng-controller="vlanCtrl">
        ...
        <div class="row panel panel-default">
            <div class="panel-heading">Reporte de Vlan's</div>
