            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        } else if ($vista == 'listaservicios') {
                            $current['listaservicios'] = 'active';
                        } else if ($vista == 'topology') {
                            $current['topology'] = 'active';
                        }
                        ?>
                        <!--<li class="{{$current['index']}}"><a href="{{URL::route('index')}}">Inicio</a></li>-->
                        <li class="{{$current['listaequipos']}} {{$current['listainterfaces']}} {{$current['listaservicios']}} dropdown">
                            <a href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                <span class="glyphicon glyphicon-phone"></span> Equipos</a>
                            <ul class="dropdown-menu">
                                ...
                                <li class="{{$current['listaservicios']}}"><a href="{{URL::route('listaservicios')}}">Servicios</a></li>
                            </ul>
                        </li>
                        <li class="{{$current['listatareas']}}"><a href="{{URL::route('listatareas')}}"><span class="glyphicon glyphicon-list-alt"></span>
                                Tareas</a></li>
                        <li class="{{$current['listausuarios']}}"><a href="{{URL::route('listausuarios')}}"><span class="glyphicon glyphicon-user"></span>
                                Usuarios</a></li>
                        <li class="{{$current['listascripts']}} {{$current['listareportes']}} {{$current['listanotifiaciones']}} 
                            {{$current['listawebservicios']}} dropdown">
                            <a href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                <span class="glyphicon glyphicon-option-vertical"></span>Opciones</a>
                            <ul class="dropdown-menu">
                                ...
                                <li class="{{$current['listawebservicios']}}"><a href="{{URL::route('listawebservicios')}}"><span class="glyphicon glyphicon-globe"></span>
                                Web Services</a></li>
                            </ul>
                        </li>
                        <li class="{{$current['generategraphs']}} dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="{{$current['topology']}}"><a href="{{URL::route('topology')}}">Topologia</a></li>
                            </ul>
                        </li>
                    </ul>
