...
//          "       ng-class=\"'level-' + {{ row.level }} + (row.branch.selected ? ' active':'')\" class=\"tree-grid-row {{row.branch['Color']}}\">\n" +
          "       ng-class=\"'level-' + {{ row.level }} \" class=\"tree-grid-row {{row.branch['Color']}}\">\n" +
      ...
      function ($timeout,
        ...
        return {
          ...
          link       : function (scope, element, attrs) {
            ...
            scope.cargarBusqueda = function (parm) {
                var res = parm.split("/");
                scope.ipAddress = res[0];
//                scope.RangeId = '';
//                scope.ipAddress = res[0];
            };
